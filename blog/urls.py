...
urlpatterns = [
    ...
    path('add_comment/<int:blogentry_id>', views.add_comment, name='add_comment'), 
    path('delete_comment/<int:blogentry_id>/<int:comment_id>', views.delete_comment, name='delete_comment'),
]
